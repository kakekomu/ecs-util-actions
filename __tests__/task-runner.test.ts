...
describe('TaskRunner', () => {
    ...
    it('should load and rewrite task definition', () => {
        ...
        expect(mockReadFileSync).toHaveBeenCalledWith(inputs.task_definition_file, 'utf8')
    ...
    it('should throw an error if task definition is not loaded', () => {
        ...
        expect(() => taskRunner['rewriteTaskDefinition']()).toThrow('task definition is not loaded')
    })
}) 
